...
/**
 * Servlet implementation class GetAllLineNames
 */
@WebServlet("/GetAllLineNames")
public class GetAllLineNames extends TrafficMasterServlet<Void, List<String>> {
	...
	protected List<String> execute(Void input) throws Exception {
		...
		return trafficBean.getAllLineNames();
	}
